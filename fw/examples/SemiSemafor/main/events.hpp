...
constexpr tet::String button = tet::String("button", "Button", true);
constexpr tet::String time = tet::String("time", "Time", true);
constexpr tet::String duration = tet::String("duration", "Duration", true);

constexpr std::tuple basicArgs = std::make_tuple(button, time);
constexpr std::tuple durationArgs = std::make_tuple(button, time, duration);
